...
import { State, pushNotification, } from "../../../store"// NOTIFICATION_SUCCESS, NOTIFICATION_ERROR, NOTIFICATION_WARNING } from "../../../store"
...
class NewOfferModal extends React.Component<Props, {}> {
  ...
  private handleChangeMonster = (event: any) => {
    ...
    const { monsters} = this.props // dispatchPushNotification,
